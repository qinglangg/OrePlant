...
public class OrePlantRecipe {
    ...
    public static void init(FMLInitializationEvent event) {
    	//甘蔗
		FurnaceRecipes.instance().addSmeltingRecipeForBlock(Crops.reedCoal, new ItemStack(Items.COAL, 1,0), 5f);
		...
		GameRegistry.addSmelting(Crops.woodQuartz, new ItemStack(Items.DYE, 1), 5.0f);
		GameRegistry.addSmelting(Crops.woodObsidian, new ItemStack(Items.REDSTONE, 1), 5.0f);
		//劣质钻石矿
